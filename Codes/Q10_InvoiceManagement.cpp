/*
Q. Create a class called Invoice that a hardware store might use to represent 
...
be set to 0. If the price per item is not positive, it should be set to 0.0. Write a 
...
Quantity         : 3
Price per Item   : Rs. 250.50
Total Amount     : Rs. 751.50

Invoice 2:
Part Number      : P2001
Part Description : Screwdriver
Quantity         : 0
Price per Item   : Rs. 120.00
